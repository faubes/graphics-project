// ==========================================================================
// $Id: element.fs,v 1.2 2016/03/12 03:39:35 jlang Exp $
...
//
// Revision 1.5  2014/03/15 04:01:14  jlang
// Fixed material and light uniform for Intel.
//
// Revision 1.4  2014/03/10 18:15:49  jlang
// Starter code complete
//
// Revision 1.3  2014/03/10 08:34:49  jlang
// Starter code draft ready
//
// Revision 1.2  2014/03/10 07:42:34  jlang
...
void main() {
  ...
  // color
  color = 0.5 * ambient + 
  	 0.5 * attenuation * spot_attenuation * diffuse;
